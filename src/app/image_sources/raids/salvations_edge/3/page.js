...
export default function SalvationsEncounter3() {
    return (
        <body className={styles.main}>
        <Image src={Background} alt={""} className={styles.background}/>
        <div className={styles.wrapper}>
            <ImageHeader title={"Salvation's Edge"} subtitle={"Encounter 3"} icon={BungieIcons.raids.salvations_edge} href={"chaosd2.com/se/3"}/>
