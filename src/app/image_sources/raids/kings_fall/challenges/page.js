...
export default function KFChallenges() {
    return (
        <body className={styles.main}>
        <Image src={Background} alt={""} className={styles.background}/>
        <div className={styles.wrapper}>
            <ImageHeader title={"King's Fall"} subtitle={"Challenges and Triumphs"} icon={BungieIcons.raids.kings_fall} href={"chaosd2.com/kf/c"}/>
