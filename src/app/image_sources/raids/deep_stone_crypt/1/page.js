...
export default function DSCEncounter1() {
    return (
        <body className={styles.main}>
            <Image src={Background} alt={""} className={styles.background}/>
            <div className={styles.wrapper}>
                <ImageHeader title={"Deep Stone Crypt"} subtitle={"Crypt Security"} icon={BungieIcons.raids.deep_stone_crypt} href={"chaosd2.com/dsc/1"}/>
