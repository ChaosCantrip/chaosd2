...
export default function VoGEncounter5() {
    return (
        <body className={styles.main}>
            <Image src={Background} alt={""} className={styles.background}/>
            <div className={styles.wrapper}>
                <ImageHeader title={"Vault of Glass"} subtitle={"Atheon, Time's Conflux"} icon={BungieIcons.raids.vault_of_glass} href={"chaosd2.com/vog/5"}/>
