...
export default function CrotaEncounter2() {
    return (
        <body className={styles.main}>
        <Image src={Background} alt={""} className={styles.background}/>
        <div className={styles.wrapper}>
            <ImageHeader title={"Crota's End"} subtitle={"Cross the Bridge"} icon={BungieIcons.raids.crotas_end} href={"chaosd2.com/crota/2"}/>
