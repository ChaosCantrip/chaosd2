...
export default function CrotaEncounter1() {
    return (
        <body className={styles.main}>
        <Image src={Background} alt={""} className={styles.background}/>
        <div className={styles.wrapper}>
            <ImageHeader title={"Crota's End"} subtitle={"Enter the Abyss"} icon={BungieIcons.raids.crotas_end} href={"chaosd2.com/crota/1"}/>
