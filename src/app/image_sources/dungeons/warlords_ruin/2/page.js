...
export default function WarlordsEncounter2() {
    return (
        <body className={styles.main}>
        <Image src={Background} alt={""} className={styles.background}/>
        <div className={styles.wrapper}>
            <ImageHeader title={"Warlord's Ruin"} subtitle={"Locus of Wailing Grief"} icon={BungieIcons.dungeons.warlords_ruin} href={"chaosd2.com/wr/2"}/>
