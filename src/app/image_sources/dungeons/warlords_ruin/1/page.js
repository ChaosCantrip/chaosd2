...
export default function WarlordsEncounter1() {
    return (
        <body className={styles.main}>
        <Image src={Background} alt={""} className={styles.background}/>
        <div className={styles.wrapper}>
            <ImageHeader title={"Warlord's Ruin"} subtitle={"Rathl, First Broken Knight of Fikrul"} icon={BungieIcons.dungeons.warlords_ruin} href={"chaosd2.com/wr/1"}/>
