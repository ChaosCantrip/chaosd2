...
export default function ProphecyEncounter2() {
    return (
        <body className={styles.main}>
        <Image src={Background} alt={""} className={styles.background}/>
        <div className={styles.wrapper}>
            <ImageHeader title={"Prophecy"} subtitle={"Hexahedron"} icon={BungieIcons.dungeons.prophecy} href={"chaosd2.com/prophecy/2"}/>
