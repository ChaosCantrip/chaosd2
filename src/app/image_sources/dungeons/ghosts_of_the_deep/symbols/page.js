...
export default function GhostsEncounter0() {
    return (
        <body className={styles.main}>
        <Image src={Background} alt={""} className={styles.background}/>
        <div className={styles.wrapper}>
            <ImageHeader title={"Ghosts of the Deep"} subtitle={"Symbols Table"} icon={BungieIcons.dungeons.ghosts_of_the_deep} href={"chaosd2.com/ghosts/symbols"}/>
            <UnfinishedSubtitle/>
