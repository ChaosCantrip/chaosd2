...
export default function DualityEncounter3() {
    return (
        <body className={styles.main}>
        <Image src={Background} alt={""} className={styles.background}/>
        <div className={styles.wrapper}>
            <ImageHeader title={"Duality"} subtitle={"Nightmare of Caiatl"} icon={BungieIcons.dungeons.duality} href={"chaosd2.com/duality/3"}/>
